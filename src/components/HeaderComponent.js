...
import { Navbar, NavbarBrand, Nav, NavbarToggler, Collapse, Jumbotron, NavItem, Button, Modal, ModalHeader, ModalBody, FormGroup, Input, Form, Label } from 'reactstrap';
                 ...
                 <Modal isOpen={this.state.isModalOpen} toggle={this.state.toggleModal}>
                     ...
                     <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <Button type="submit" value="submit" colo="primary">Login</Button>
                        </Form>
                     </ModalBody>
                 </Modal>
            </>
